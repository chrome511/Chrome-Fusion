...
if (iMODERATOR  || $userdata['user_id'] == 1) {
...
if (isset($_POST['send_message'])) {
  ...
  if (iMODERATOR && isset($_POST['chk_sendtoall']) && isnum($_POST['msg_to_group'])) {
		$msg_to_group = $_POST['msg_to_group'];
    if ($msg_to_group == "101" || $msg_to_group == "102" || $msg_to_group == "103" || $msg_to_group == "104" || $msg_to_group == "105") {
			$result = dbquery(
...
if (!isset($_GET['msg_send']) && !isset($_GET['msg_read']) && $_GET['folder'] != "options") {
  ...
  if (iMODERATOR && !isset($_GET['msg_id'])) {
