...
if (iMODERATOR && !defined("ADMIN_PANEL") && !defined("MOD_PANEL")) {
	...
	if (!$userdata['user_admin_password'] && $userdata['user_level'] == "102" && $userdata['user_level'] == "103") $ad_mess[] = $locale['global_199a'];
  elseif (!$userdata['user_admin_password']) $ad_mess[] = $locale['global_199'];
	if (!empty($ad_mess)) {
...
foreach ($p_name as $p_key => $p_side) {
	if (isset($panels_cache[$p_key + 1]) || defined("ADMIN_PANEL") || defined("MOD_PANEL")) {
		ob_start();
    if (!defined("ADMIN_PANEL") && !defined("MOD_PANEL")) {
...
if (defined("ADMIN_PANEL") || defined("MOD_PANEL") || LEFT && !RIGHT) {
