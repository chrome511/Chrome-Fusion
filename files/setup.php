...
| Modified and compatible to PHP 7.1
...
echo "<td class='full-header'><img src='images/chrome-fusion-logo.png' alt='Chrome-Fusion' /></td>\n";
echo "</tr>\n</table>\n";
...
if (isset($_POST['step']) && $_POST['step'] == "5") {
  ...
  $siteadminemail = (isset($_POST['siteadminemail']) ? stripinput(trim($_POST['siteadminemail'])) : "");
	...
	echo "<tr>\n<td class='tbl1'>".$locale['066a']."</td>\n";
	echo "<td class='tbl1' style='text-align:right'><input type='text' name='siteadminemail' value='".$siteadminemail."' maxlength='100' class='textbox".$field_class[6]."' style='width:200px' /></td></tr>\n";
	echo "</table>\n";
	echo "</td>\n</tr>\n<tr>\n<td class='tbl2' style='text-align:center'>\n";
	echo "<input type='hidden' name='localeset' value='".stripinput($_POST['localeset'])."' />\n";
...
if (isset($_POST['step']) && $_POST['step'] == "6") {
	...
	if ($error == "") {
		if ($rows == 0) {
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('version', '2.00.03')");
