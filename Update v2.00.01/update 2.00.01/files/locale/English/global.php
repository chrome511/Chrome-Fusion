...
$locale['user5'] = "Super Administrator";
$locale['user_na'] = "N/A";
...
$locale['global_105'] = "Not a member yet?<br /><a href='".BASEDIR."register.php' class='side'><u>Click here</u></a> to register.";
$locale['global_106'] = "Forgotten your password?<br />Request a new one <a href='".BASEDIR."lostpassword.php' class='side'><u>here</u></a>.";
...
$locale['global_123a'] = "Moderator Panel";
...
$locale['global_182a'] = "<strong>Notice:</strong> Moderator password not entered or incorrect.";
// Miscellaneous
...
$locale['global_199a'] = "<strong>Warning:</strong> moderator password not set, click <a href='".BASEDIR."edit_profile.php'>Edit Profile</a> to set it.";
//Titles
$locale['global_200'] = " - ";
$locale['global_201'] = ": ";
...
Please contact the site administrator at ".$settings['siteadminemail']." to have your account restored or report if this was not you causing this security ban.\n
