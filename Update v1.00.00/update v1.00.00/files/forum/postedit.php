...
if (isset($_POST['savechanges'])) {
  ...
  if(iMOD || iMODERATOR) echo "<label><input type='checkbox' name='hide_edit' value='1' /> ".$locale['487']."</label><br />\n";
	if(iMOD || iMODERATOR) echo "<label><input type='checkbox' name='post_locked' value='1'".$post_locked." /> ".$locale['488']."</label><br />\n";
