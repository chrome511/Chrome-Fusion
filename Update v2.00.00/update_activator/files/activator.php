...
if (isset($_POST['action']) && ($_POST['action'] == "german")) {
    ...
    echo "Dieses kleine Script aktiviert die Update Funktion von Chrome-Fusion v2.00.00 um auf Chrome-Fusion v2.00.01 zu aktualisieren.<br>";
...
if (isset($_POST['action']) && ($_POST['action'] == "english")) {
    ...
    echo "This small script activates the update function in Chrome-Fusion v2.00.00 in order to upgrade to Chrome-Fusion v2.00.01<br>";
...
if (isset($_GET['aktivieren_ok'])) {
    opentable("Ergebniss:");
    echo "Die Updatefunktion von Chrome-Fusion v2.00.00 wurde erfolgreich aktiviert.<br>";
    echo "Chrome-Fusion v2.00.00 kann nun aktualisiert werden.<br>";
...
if (isset($_GET['activate_ok'])) {
    opentable("Result:");
    echo "The update function of Chrome-Fusion v2.00.00 has been succesfully activated.<br>";
    echo "Chrome-Fusion v2.00.00 can now be upgraded to Chrome-Fusion v2.00.01.<br>";
