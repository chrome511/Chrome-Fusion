...
echo stripslashes(nl2br($settings['maintenance_message']))."<br /><br /><br />\n";
echo "Powered by <a href='http://chrome-fusion.de'>Chrome-Fusion</a> &copy; 2016 - ".date("Y")."<br />\n";
...
if (!iMEMBER) {
	...
	echo "<input type='checkbox' name='remember_me' value='y' title='".$locale['global_103']."' ".$locale['global_103']." />\n";
