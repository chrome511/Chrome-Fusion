...
if (iMEMBER) {
  ...
  if (iMODERATOR && $userdata['user_level'] == "102" || $userdata['user_level'] == "103" && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
		echo THEME_BULLET." <a href='".ADMIN."index.php".$aidlink."' class='side'>".$locale['global_123a']."</a><br />\n";
  } else if (iADMIN && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
  ...
  if (iMODERATOR && checkrights("SU")) {
	...
	if (!preg_match('/login.php/i',FUSION_SELF)) {
		...
		echo "<label><input type='checkbox' name='remember_me' value='y' title='".$locale['global_103']."' style='vertical-align:middle;' />".$locale['global_103']."</label>\n";
