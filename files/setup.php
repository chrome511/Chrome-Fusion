...
if ((isset($_POST['step']) && $_POST['step'] == "8") || (isset($_GET['step']) && $_GET['step'] == "8")) {
	header("Location: index.php");
}
$timestamp = time();
$datum = date("Y");
$copyright = 'Powered by
<a href="http://www.chrome-fusion.de/" target="_blank">Chrome-Fusion</a>
copyright &copy; 2016 - '.$datum.' by Patrick Kruse.<br /><br />
Powered by
<a href="http://www.php-fusion.co.uk/" target="_blank">PHP-Fusion</a>
copyright &copy; 2002 - '.$datum.' by Nick Jones.<br />Released as free software without warranties under
<a target="_blank" href="http://www.gnu.org/licenses/agpl-3.0.html/">GNU Affero GPL</a>
v3.';
...
echo '<link href="themes/templates/setup/dist/css/bootstrap.css" rel="stylesheet">
      <!-- Documentation extras -->
      <link href="themes/templates/setup/assets/css/docs.css" rel="stylesheet">
      <link href="themes/templates/setup/assets/css/pygments-manni.css" rel="stylesheet">
      <script type="text/javascript" src="themes/templates/setup/assets/js/jquery.js"></script>  
        ';
...
echo '<body class="bs-docs-home" data-twttr-rendered="true" style="-moz-user-select: text;">';
        echo '<main role="main" id="content" class="bs-masthead">  
            <div class="container text-center">
                <h1>'.$locale["500"].'</h1>
                <p class="lead text-center">'.$locale["010"].'</p>';
      ...
      echo "<select name='localeset' class='textbox' style='margin-top:5px'>\n";
	    echo $locale_list."</select><br /><br />\n";
              echo "<input type='hidden' name='step' value='2' />\n";
                echo "<p class='text-center'><input type='submit' name='next' value='".$locale['007']."' class='btn btn-primary btn-lg' /></p>\n";
                
                echo '<p class="text-center">'.$locale["503"].'</p>
                <p>'.$locale["504"].'</p>  
            </div>
        </main>';
echo '<footer role="contentinfo" class="bs-footer text-center">'.$copyright.'</footer>';
echo '</body>';
...
echo '<body class="bs-docs-home" data-twttr-rendered="true" style="-moz-user-select: text;">';
        echo '<main role="main" id="content" class="bs-masthead">  
            <div class="container text-center">
                <h1>'.$locale["500"].'</h1>
                <p class="lead text-center">'.$locale["501"].'</p>';
                
            	$locale_files = makefilelist("locale/", ".svn|.|..", true, "folders");
            	$locale_list = makefileopts($locale_files);
              echo "<input type='hidden' name='localeset' value='".stripinput($_POST['localeset'])."' />\n";
              echo "<input type='hidden' name='step' value='3' />\n";
                echo "<p class='text-center'><input type='submit' name='next' value='".$locale['502']."' class='btn btn-primary btn-lg' /></p>\n";
...
if (isset($_POST['step']) && $_POST['step'] == "3") {
	...
	foreach ($check_arr as $key => $value) {
		...
		$check_display .= "<td class='tbl1' style='text-align:right'>".($check_arr[$key] == true ? "<span class='passed'><span class='glyphicon glyphicon-ok' style='color:#21D101'></span></span>" : "<span class='failed'><span class='glyphicon glyphicon-remove' style='color:#ff0000'></span></span>")."</td>\n</tr>\n";
	}
    
    
    echo '<body data-twttr-rendered="true">';
    echo '<header role="banner" class="navbar navbar-inverse navbar-fixed-top">  
    <div class="container">    
    ...
    <a class="navbar-brand" href="#">'.$locale['505'].'</a>    
    </div></div></header>';
    echo '<div id="content" class="bs-header">
            <div class="container">
            <h1>'.$locale['506'].'</h1>
            <p>'.$locale['507'].'</p>
            </div>
    ...
    echo '<div class="container bs-docs-container">
            <div class="row">
            <div class="col-md-3"><div class="nav bs-sidenav" role="complementary" style="padding-left: 10px; padding-right: 10px;">
            <h4>'.$locale['508'].'</h4>
            <p>
            '.$locale['509'].'
            </p></div></div>
            ...
            <div class="page-header">';
                if ($write_check) {
                echo '<h5>'.$locale['021'].'</h5>';
                }else{
                echo '<h5>'.$locale['022'].'</h5>';    
                }
...
if ($write_check) {
		...
		echo "<p class=\"text-center\"><input type='submit' name='next' value='".$locale['009']."' class='btn btn-success'></p>\n";
	} else {
		echo "<input type='hidden' name='localeset' value='".stripinput($_POST['localeset'])."' />\n";
		echo "<input type='hidden' name='step' value='3' />\n";
		echo "<p class=\"text-center\"><input type='submit' name='next' value='".$locale['025']."' class='btn btn-success'></p>\n";
	}
echo '</div>
    ...
    echo '<footer role="contentinfo" class="bs-footer2">    <p>'.$copyright.'</p></footer>';
...
if (isset($_POST['step']) && $_POST['step'] == "4") {
    ...
    $db_driver = (isset($_POST['db_driver']) ? stripinput(trim($_POST['db_driver'])) : $db_driver);
    ...
    <div class="col-md-9" role="main">
    <div class="page-header">'.$locale["513"].'';
    ...
    <label for='exampleInputEmail1'>".$locale['514']."</label>
    <input id='exampleInputEmail1' class='form-control' type='text' value='".$db_host."' name='db_host'>
    </div>
    
    <!--User-->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['515']."</label>
    <input id='exampleInputEmail1' class='form-control' type='text' value='".$db_user."' name='db_user'>
    </div>
    
    <!--Password-->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['516']."</label>
    <input id='exampleInputEmail1' class='form-control' type='password' name='db_pass'>
    </div>
    
    <!--DB Name-->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['517']."</label>
    <input id='exampleInputEmail1' class='form-control' value='".$db_name."' name='db_name'>
    </div>
    
    <!--DB Prefix-->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['518']."</label>
    <input id='exampleInputEmail1' class='form-control' value='".$db_prefix."' name='db_prefix'>
    </div>

    <!--DB Driver (pdo or mysqli) -->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['518a']."</label>
    ...
    <!--DB Cookie-->
    <div class='form-group'>
    <label for='exampleInputEmail1'>".$locale['519']."</label>
    <input id='exampleInputEmail1' class='form-control' value='".$cookie_prefix."' name='cookie_prefix'>
    </div>
    ";
    
    echo "<input type='hidden' name='localeset' value='".stripinput($_POST['localeset'])."' />\n";
    	echo "<input type='hidden' name='step' value='5' />\n";
    	echo "<p class=\"text-right\"><input type='submit' name='next' value='".$locale['007']."' class='btn btn-success' /></p>\n";
...
//step 5 - Database connect & structure
if (isset($_POST['step']) && $_POST['step'] == "5") {
	...
	if ($db_host != "" && $db_user != "" && $db_name != "" && $db_prefix != "") {
		...
		// Establish mySQL database connection fpr PHP 7
...
<div class="page-header">'.$locale["522"].'';
...
<div class="bs-example">';
    ...
    <div class="row">
    <div class="col-md-12" role="main">
    <div class="page-header">'.$locale["525"].'';
...
<div class="bs-example">';
	...
	if ($success) {
		...
		echo "<input type='submit' name='next' value='".$locale['007']."' class='btn btn-success' />\n";
	} else {
		echo "<input type='hidden' name='step' value='4' />\n";
		...
		echo "<input type='hidden' name='db_driver' value='".$db_driver."' />\n";
		echo "<input type='hidden' name='db_error' value='".$db_error."' />\n";
		echo "<input type='submit' name='next' value='".$locale['008']."' class='btn btn-success' />\n";
	}
...
if (isset($_POST['step']) && $_POST['step'] == "6") {
	...
	$siteadminemail = (isset($_POST['siteadminemail']) ? stripinput(trim($_POST['siteadminemail'])) : "");
	...
	$error_siteadminemail = (isset($_POST['error_siteadminemail']) && isnum($_POST['error_siteadminemail']) ? $_POST['error_siteadminemail'] : "0");
	...
	if ($error_pass == "1" || $error_name == "1" || $error_mail == "1") {
		...
		if ($error_siteadminemail == 1) { $field_class[6] = " tbl-error"; }
	}
...
<div class="col-md-9" role="main">
<div class="page-header">'.$locale["529"].'';
...
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["530"].'</label>        
        <input type="text" name="username" value="'.$username.'" maxlength="64"  id="exampleInputEmail1" class="form-control">      
        </div>';
//Password
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["531"].'</label>        
        <input type="password" name="password1" maxlength="64" id="exampleInputEmail1" class="form-control">      
        </div>';
        
//Password wiederholen
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["532"].'</label>        
        <input type="password" name="password2" maxlength="64"  id="exampleInputEmail1" class="form-control">      
        </div>';
        
//Admin Password
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["533"].'</label>        
        <input type="password" name="admin_password1" maxlength="64" id="exampleInputEmail1" class="form-control">     
        </div>';

//Admin Password wiederholen
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["534"].'</label>        
        <input type="password" name="admin_password2" maxlength="64"  id="exampleInputEmail1" class="form-control">      
        </div>';
        
//Email
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["535"].'</label>        
        <input type="text" name="email" value="'.$email.'" maxlength="100"  id="exampleInputEmail1" class="form-control">      
        </div>';
        
//Admin Email
echo '<div class="form-group">        
        <label for="exampleInputEmail1">'.$locale["535a"].'</label>        
        <input type="text" name="siteadminemail" value="'.$siteadminemail.'" maxlength="100"  id="exampleInputEmail1" class="form-control">      
        </div>';
...
if (isset($_POST['step']) && $_POST['step'] == "7") {
	...
	$siteadminemail = (isset($_POST['siteadminemail']) ? stripinput(trim($_POST['siteadminemail'])) : "");
 	...
 	if ($siteadminemail == "") {
		$error .= $locale['076b']."<br /><br />\n";
		$error_mail = "1";
	} elseif (!preg_match("/^[-0-9A-Z_\.]{1,50}@([-0-9A-Z_\.]+\.){1,50}([0-9A-Z]){2,4}$/i", $siteadminemail)) {
		$error .= $locale['076']."<br /><br />\n";
		$error_mail = "1";
	}
	...
	if ($error == "") {
		if ($rows == 0) {
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('sitename', 'Chrome-Fusion powered Website')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('sitebanner', 'images/chrome-fusion-logo.png')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('siteadminemail', '".$siteadminemail."')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('tinymce_enabled', '1')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('smtp_secure', 'tls')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('version', '2.00.01')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('login_method', '0')"); //new in v7.03 BIZ
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('email_signature', '')"); //new in v7.03 BIZ
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('recaptcha_type', 'text')"); //new in v7.03 BIZ
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('tinymce_bgcolor', '')"); //new in v7.03 BIZ
			...
			$result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('MOD', 'moderators.gif', '".$locale['080a']."', 'moderators.php', '2')");
			$result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('MPWR', 'moderator_pass.gif', '".$locale['128a']."', 'moderator_reset.php', '2')");
			...
			$result = dbquery(
				"INSERT INTO ".$db_prefix."users (
					...
					'".$siteadminemail."', '1', '0', '',  '0', '', '".time()."', '0', '0.0.0.0',
					'A.AC.AD.APWR.B.BB.C.CP.DB.DC.D.ERRO.FQ.F.FR.IM.I.IP.M.MOD.MPWR.N.NC.P.PH.PI.PO.ROB.SL.S1.S2.S3.S4.S5.S6.S7.S8.S9.S10.S11.S12.SB.SM.SU.UF.UFC.UG.UL.W.WC',
					'', '105', '0', 'Default', '', '0000-00-00', '', '', '', '', '', ''
				)"
			);
			...
			$result = dbquery("INSERT INTO ".$db_prefix."news_cats (news_cat_name, news_cat_image) VALUES ('".$locale['191']."', 'chrome-fusion.gif')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (1, '".$locale['200']."', 'rank_super_admin.png', 0, '1', 105)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (2, '".$locale['201']."', 'rank_admin.png', 0, '1', 104)");
      $result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (3, '".$locale['202a']."', 'rank_smod.png', 0, '1', 103)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (4, '".$locale['202']."', 'rank_mod.png', 0, '1', 102)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (5, '".$locale['202b']."', 'rank_fmod.png', 0, '1', 106)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (6, '".$locale['203']."', 'rank0.png', 0, '0', 101)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (7, '".$locale['204']."', 'rank1.png', 10, '0', 101)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (8, '".$locale['205']."', 'rank2.png', 50, '0', 101)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (9, '".$locale['206']."', 'rank3.png', 200, '0', 101)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (10, '".$locale['207']."', 'rank4.png', 500, '0', 101)");
			$result = dbquery("INSERT INTO ".$db_prefix."forum_ranks VALUES (11, '".$locale['208']."', 'rank5.png', 1000, '0', 101)");
		}
...
<div class="col-md-12" role="main">
<div class="page-header">'.$locale["538"].'';
...
<div class="bs-example">';
		...
		echo "<p class=\"text-center\"><input type='submit' name='next' value='".$locale['009']."".$locale['540']."' class='btn btn-success' /></p>\n";
    ...
    <a class="navbar-brand" href="#">Chrome-Fusion 2.00.00 Installation</a>    
    </div></div></header>';
    echo '<div id="content" class="bs-header">
            <div class="container">
            <h1>Fehler</h1>
            <p>Es ist ein Fehler passiert !</p>
            </div>
            </div>';
...
<div class="col-md-12" role="main">
<div class="page-header">Folgener Fehler ist aufgetreten: ';
...
<div class="bs-example">';
		...
		echo "<input type='hidden' name='siteadminemail' value='".$siteadminemail."' />\n";
		echo "<input type='hidden' name='step' value='6' />\n";
		echo "<input type='submit' name='back' value='".$locale['008']."' class='btn btn-success' />\n";
        echo '</div>
...
<div class="bs-example">';
		...
		echo "<input type='hidden' name='localeset' value='".stripinput($_POST['localeset'])."' />\n";
		echo "<input type='hidden' name='step' value='8' />\n";
		echo "<p class=\"text-center\"><input type='submit' name='next' value='".$locale['540']."' class='btn btn-success' /></p>\n";
...
function dbconnect($db_host, $db_user, $db_pass, $db_name) {
	...
	if (mysqli_connect_errno()) {
		die("<strong>Unable to establish connection to MySQL</strong><br />".mysqli_connect_errno().": ".mysqli_connect_error());
	}
}
...
if (isset($db_connect) && $db_connect != false) { mysqli_close($db_connect); }
?>
