...
$locale['user2']          = "Moderator";
$locale['user3']          = "Super Moderator";
$locale['user4']          = "Administrator";
$locale['user5']          = "Seiten Administrator";
$locale['user_na']        = "N/A";
...
$locale['global_105'] = "Noch kein Mitglied?<br /><a href='".BASEDIR."register.php' class='side' title='Klicke hier'><u>Klicke hier</u></a> um dich zu registrieren";
$locale['global_106'] = "Passwort vergessen?<br />Um ein neues Passwort anzufordern <a href='".BASEDIR."lostpassword.php' class='side' title='klicke hier'><u>klicke hier</u></a>.";
...
$locale['global_123a'] = "Moderatorbereich";
...
$locale['global_182a'] = "<strong>Hinweis:</strong> Dein Moderator Passwort ist fehlerhaft oder wurde nicht eingegeben.";
...
$locale['global_199a'] = "<strong>Hinweis:</strong> Du hast noch kein Moderator Passwort festgelegt, klicke auf <a href='".BASEDIR."edit_profile.php' title='Profil bearbeiten'>Profil bearbeiten</a> um eines zu setzen.";
...
$locale['global_301'] .= "Wenn du ein normaler Benutzer bist, berichte bitte dem Seiten Administrator unter ".hide_email($settings['siteadminemail'])." &uuml;ber dieses Problem.<br />\n";
...
$locale['global_442'] .= "Um deinen Account wieder zu aktivieren, oder uns mitzuteilen, dass dies nicht der Grund für die Sperre sein kann, kontaktiere bitte den Seiten Administrator unter ".$settings['siteadminemail']."\n\n";
