...
#else {
#	$colour_switcher->switching("select", "colour", "png", "blue", "switcherbutton");
#}
...
if ($settings['rendertime_enabled'] == 1 || ($settings['rendertime_enabled'] == 2 && iMODERATOR) || ($settings['rendertime_enabled'] == 3 && iADMIN)) {
