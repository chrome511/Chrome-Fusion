...
if (!iMODERATOR || $userdata['user_rights'] == "" || !defined("iAUTH") || !isset($_GET['aid']) || $_GET['aid'] != iAUTH) { redirect("../index.php"); }
...
if ($userdata['user_level'] == "102" || $userdata['user_level'] == "103") opentable($locale['200a']." - v".$settings['version']);
else opentable($locale['200']." - v".$settings['version']." ");
