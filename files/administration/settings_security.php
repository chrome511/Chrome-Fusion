...
if (isset($_POST['savesettings'])) {
	...
	if (!$result) { $error = 1; }
	$result = dbquery("UPDATE ".DB_SETTINGS." SET settings_value='".(isnum($_POST['maintenance_level']) ? $_POST['maintenance_level'] : "104")."' WHERE settings_name='maintenance_level'");
	if (!$result) { $error = 1; }
...
echo "<option value='103'".($settings['maintenance_level'] == "103" ? " selected='selected'" : "").">".$locale['676a']."</option>\n";
echo "<option value='104'".($settings['maintenance_level'] == "104" ? " selected='selected'" : "").">".$locale['677']."</option>\n";
echo "<option value='105'".($settings['maintenance_level'] == "105" ? " selected='selected'" : "").">".$locale['677a']."</option>\n";
