...
if ($settings['forum_ranks']) {
  ...
  echo "<option value='106'".($rank_apply == 106 ? " selected='selected'" : "").">".$locale['425b']."</option>\n";
  echo "<option value='102'".($rank_apply == 102 ? " selected='selected'" : "").">".$locale['425']."</option>\n";
  echo "<option value='103'".($rank_apply == 103 ? " selected='selected'" : "").">".$locale['425a']."</option>\n";
  echo "<option value='104'".($rank_apply == 104 ? " selected='selected'" : "").">".$locale['426']."</option>\n";
  echo "<option value='105'".($rank_apply == 105 ? " selected='selected'" : "").">".$locale['427']."</option>\n";
	echo "</select></span>\n";
	// Special Select
	$groups_arr = getusergroups(); $groups_except = array(0, 101, 102, 103, 104, 105);
	...
	if (dbrows($result)) {
      ...
      echo "<td width='1%' class='".$row_color."' style='white-space:nowrap'>".($data['rank_apply'] == 106 ? $locale['425b'] : getgroupname($data['rank_apply']))."</td>\n";
